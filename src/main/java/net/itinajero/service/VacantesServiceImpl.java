...
public class VacantesServiceImpl implements IVacantesService {
	...
	public VacantesServiceImpl() {
		...
		try {
			...
			vacante3.setDescripcion("Empresa internacional solicita Ingeniero mecánico para mantenimiento de la instalación elétrica.");
	...
	public void guardar(Vacante vacante) {
		lista.add(vacante); /*Recuerda que este objecto es el que  enviara al contorlador atraves de la clase servico */
	}
